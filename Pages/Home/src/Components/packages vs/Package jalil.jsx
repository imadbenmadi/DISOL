                    ...
                    <div className="grid items-center gap-8 relative md:grid-cols-2">
                        ...
                        <div className="rounded-3xl lg:max-w-[80%] lg:ml-32 bg-white p-8 shadow-2xl">
                            <h3 className="text-2xl font-bold text-gray-900">
                                {data.packages[selectedPackage].basic.title}
                            </h3>
                            <p className="mt-4 text-gray-600">
                                {
                                    data.packages[selectedPackage].basic
                                        .description
                                }
                            </p>
                            <div className="my-8">
                                <div className="text-4xl font-bold text-[#0088cc]">
                                    {data.packages[selectedPackage].basic.price}
                                </div>
                            </div>
                            <ul className="mb-8 space-y-4">
                                {data.packages[
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                d="M13.6573 21.752L8 16.0934L9.88533 14.208L13.6573 17.9787L21.1987 10.436L23.0853 12.3227L13.6573 21.752Z"
                                                fill="black"
                                                fillOpacity="0.6"
                                            />
                                            <path
                        ...
                        <div className="rounded-3xl lg:max-w-[80%] bg-white p-8 shadow-2xl">
                            <h3 className="text-2xl font-bold text-gray-900">
                                {data.packages[selectedPackage].premium.title}
                            </h3>
                            <p className="mt-4 text-gray-600">
                                {
                                    data.packages[selectedPackage].basic
                            ...
                            <div className="my-8">
                                <div className="text-4xl font-bold text-[#0088cc]">
                                    {
                                        data.packages[selectedPackage].premium
                                            .price
                                    }
                                </div>
                            </div>
