...
const Review = () => {
    ...
    const filteredTestminoalOne = data.testimonials.filter(
        (service) => service.id <= numberCards / 2
    );

    const filteredTestminoalTwo = data.testimonials.filter(
        (service) => service.id > numberCards / 2
    );
    ...
    const handleDragEnd = (event, info) => {
        ...
        if (
            swipe < -threshold &&
            currentIndex < filteredTestminoalOne.length - 1
        ) {
    ...
    return (
        <>
            <section
                className="px-4 py-16 sm:px-6 overflow-hidden lg:max-h-[850px] lg:px-8"
                id="about"
            >
                <div className="mx-auto max-w-7xl">
                    <h2 className="mb-12 text-center text-4xl font-bold text-black">
                        Our Happy{" "}
                        <span className="text-[#0088cc]">Clients</span>
                    </h2>
                    ...
                    >
                        <motion.div
                            ...
                            dragConstraints={{
                                left:
                                    -width * (filteredTestminoalOne.length - 1),
                                right: 0,
                            }}
                        ...
                        <motion.div
                            ...
                            dragConstraints={{
                                left:
                                    -width * (filteredTestminoalTwo.length - 1),
                                right: 0,
                            }}
                            onDragEnd={handleDragEnd}
                            className="flex gap-4 lg:gap-6"
