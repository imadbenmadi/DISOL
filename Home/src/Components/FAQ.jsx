        ...
        <>
            ...
            >
                <div className="mx-auto max-w-4xl">
                    <h2 className="text-center text-4xl font-bold text-[#0088cc] sm:text-5xl">
                        Questions
                    </h2>
                            ...
                            >
                                <button
                                    ...
                                    className="flex w-full items-center justify-between py-5 text-left
                                     text-xl font-medium text-white transition-colors hover:text-[#0088cc] 
                                     focus:outline-none focus:ring-2 focus:ring-[#0088cc] focus:ring-offset-2"
                                    aria-expanded={openItem === item.id}
                                    aria-controls={`faq-answer-${item.id}`}
                                >
                                    <span className="pr-8 text-black">
                                        {item.question}
                                    </span>
